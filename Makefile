...
KIND_CLUSTER ?= sandbox-factory-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name sandbox-factory-builder
	$(CONTAINER_TOOL) buildx use sandbox-factory-builder
	...
	- $(CONTAINER_TOOL) buildx rm sandbox-factory-builder
	rm Dockerfile.cross
